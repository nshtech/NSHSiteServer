...
;( function( window ) {
	...
	ElastiStack.prototype._moveAway = function( instance ) {
		...
		// add class "elastic-animate"
		classie.add( instance.element, 'elastic-animate' );
		...
		if( item2 ) {
			...
			classie.add( item2, 'elastic-animate' );
			setTransformStyle( item2, is3d ? 'translate3d(0,0,-60px)' : 'translate(0,0)' );
		}
		if( item3 ) {
			classie.add( item3, 'move-back' );
			classie.add( item3, 'elastic-animate' );
			setTransformStyle( item3, is3d ? 'translate3d(0,0,-120px)' : 'translate(0,0)' );
		}
		...
		var self = this,
			onEndTransFn = function() {
				...
				classie.remove( instance.element, 'elastic-animate' );
				...
				setTimeout( function() {
					// the upcoming one will elastic-animate..
					classie.add( self._lastItem(), 'elastic-animate' );
					// reset style
					self._setStackStyle();
				}, 25 );
	...
	ElastiStack.prototype._onDragStart = function( instance, event, pointer ) {
		...
		if( item2 ) {
			...
			classie.remove( item2, 'elastic-animate' );
		}
		if( item3 ) {
			classie.remove( item3, 'move-back' );
			classie.remove( item3, 'elastic-animate' );
		}
	};
